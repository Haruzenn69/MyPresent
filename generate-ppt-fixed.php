...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rIdTheme" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme" Target="../theme/theme1.xml"/>
    ...
    {
        $title = htmlspecialchars($slide['title'], ENT_XML1 | ENT_QUOTES, 'UTF-8');
        $lines = explode("\n", $slide['content']);
        $contentLines = array_map(fn($l) => htmlspecialchars($l, ENT_XML1 | ENT_QUOTES, 'UTF-8'), $lines);
    ...
    {
        $sub = htmlspecialchars($subtitle, ENT_XML1 | ENT_QUOTES, 'UTF-8');
...
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"
  ...
  <p:cSld>
    ...
    {
        $escaped = htmlspecialchars($content, ENT_XML1 | ENT_QUOTES, 'UTF-8');
        return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"
       xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"
       xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
