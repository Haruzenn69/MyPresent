            ...
            <div class="admin-card" style="--card-border:#0D9488;--card-glow:rgba(13,148,136,0.15);padding:24px;max-width:600px;">
                <form method="POST" action="{{ route('admin.classes.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="nama_kelas" name="nama_kelas" type="text" value="{{ old('nama_kelas') }}" required style="border-radius:10px;border:1px solid var(--md-sys-color-outline-variant);background:var(--md-sys-color-surface);color:var(--md-sys-color-on-surface);font-size:13px;padding:10px 14px;width:100%;">
