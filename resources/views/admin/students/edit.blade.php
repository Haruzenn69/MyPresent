    ...
    <div style="background:var(--md-sys-color-surface);min-height:100vh;">
        <div class="container-fluid py-4" style="max-width:1200px;">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                <div>
                    <h1 style="font-size:22px;font-weight:700;color:var(--md-sys-color-on-surface);margin:0;">Edit Siswa</h1>
                    <p style="font-size:13px;color:var(--md-sys-color-on-surface-variant);margin:4px 0 0;">Perbarui data siswa</p>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <x-text-input id="nis" name="nis" type="text" class="form-control" value="{{ old('nis', $student->nis) }}" required />
                                @error('nis')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <x-text-input id="nama" name="nama" type="text" class="form-control" value="{{ old('nama', $student->nama) }}" required />
                                @error('nama')
                                <x-input-error :messages="$message" />
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <x-text-input id="email" name="email" type="email" class="form-control" value="{{ old('email', $student->user->email) }}" required />
                                @error('email')
                                <x-input-error :messages="$message" />
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <x-text-input id="password" name="password" type="password" class="form-control" placeholder="Kosongkan jika tidak diubah" />
                                @error('password')
                                <x-input-error :messages="$message" />
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea id="alamat" name="alamat" class="form-control" style="border-radius:10px;border:1px solid var(--md-sys-color-outline-variant);background:var(--md-sys-color-surface);color:var(--md-sys-color-on-surface);font-size:13px;padding:10px 14px;width:100%;min-height:80px;">{{ old('alamat', $student->alamat) }}</textarea>
                            </div>
                        </div>
                    </div>
