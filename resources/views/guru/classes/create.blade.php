    ...
    <div style="background:var(--md-sys-color-surface);min-height:100vh;">
        <div class="container-fluid py-4" style="max-width:1200px;">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                <div>
                    <h1 style="font-size:22px;font-weight:700;color:var(--md-sys-color-on-surface);margin:0;">Tambah Kelas</h1>
                    <p style="font-size:13px;color:var(--md-sys-color-on-surface-variant);margin:4px 0 0;">Buat kelas baru</p>
                </div>
            ...
            <div class="admin-card" style="--card-border:#0D9488;--card-glow:rgba(13,148,136,0.15);padding:24px;max-width:600px;">
                <form method="POST" action="{{ route('guru.classes.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="nama_kelas" name="nama_kelas" type="text" value="{{ old('nama_kelas') }}" placeholder="Contoh: XII RPL 1" style="border-radius:10px;border:1px solid var(--md-sys-color-outline-variant);background:var(--md-sys-color-surface);color:var(--md-sys-color-on-surface);font-size:13px;padding:10px 14px;width:100%;">
                        @error('nama_kelas')
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" style="background:var(--md-sys-color-primary);color:white;border:none;border-radius:20px;padding:8px 24px;font-size:13px;font-weight:500;cursor:pointer;">Simpan Kelas</button>
                    </div>
                </form>
            </div>
